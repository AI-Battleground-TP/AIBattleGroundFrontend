...
export const Dashboard: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!comparisonTitle.trim()) {
      setAlertMessage("Please enter a comparison title");
  ...
  return (
    <div className="space-y-8">
      {showToast && (
        <Toast
          message="Your comparison has started. You can follow progress on the Results page."
          type="success"
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Create multi-model comparisons with question pools
          </p>
        </div>
      </div>

      <Card title="Start New Comparison" className="relative">
        {/* Loading Overlay */}
        {isSubmitting && (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-background/95 rounded-lg">
            <div className="text-center space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="text-xl font-semibold text-foreground">Setting Up Your Comparison</h3>
          ...
          <AlertDescription>
            ...
            pool and a question pool. The system will generate pairwise comparisons
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Give your comparison a descriptive name
            </p>
          </div>
              ...
              <div className="mt-3 text-sm text-primary">
                ...
                {selectedModelIds.length >= 2 && (
                  <span className="ml-2">
                    ...
                    comparison{(selectedModelIds.length * (selectedModelIds.length - 1)) / 2 !== 1 ? 's' : ''} will be created)
                  </span>
                )}
              </div>
            )}
